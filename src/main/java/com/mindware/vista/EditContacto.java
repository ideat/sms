...
public class EditContacto extends Window implements ClickListener{
     ...
     * visual editor.
     */
    public EditContacto(Contacto contactoEdit) {
        buildMainLayout();
        //setCompositionRoot(mainLayout);
        setContent(mainLayout);
        llenarDatos(contactoEdit);
        postBuild();
    }
    ...
    public void llenarDatos(Contacto contacto){
        textField_6.setValue(contacto.getCelular());
        textField_4.setValue(contacto.getNombreContacto());
        textField_7.setValue(contacto.getCampo1());
        textField_8.setValue(contacto.getCampo2());
        textField_9.setValue(contacto.getCampo3());
        ...
        if(event.getSource()==this.btnguardar){
            if(validarDatos()){
                ...
                MessageBox.createInfo()
                        ...
                        .withMessage("Datos actualizados!")
                        .open();
                close();
            }
            else {
