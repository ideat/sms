...
public class LoginUI extends CustomComponent implements ClickListener {
	...
	private AbsoluteLayout buildBorde() {
		...
		borde.addComponent(label_6, "top:70.0px;left:102.0px;");
		...
		borde.addComponent(txtClave, "top:70.0px;left:144.0px;");
		...
		borde.addComponent(btnIngresar, "top:134.0px;left:68.0px;");
