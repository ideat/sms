...
public class Componer extends CustomComponent {
	...
	public Componer() {
		...
		setVariable();
		Formato();
        listaGrupoUsuario(1); //TODO: Reemplazar por codigo usuario
		//Envio de mensajes
  	    sendMessages();
	}
                        ...
                        if (!txtNumeros.isEmpty()) {
                             mensajes = mensajeService.prepararMensajes(txtMensaje.getValue(),
                                    contactoService.contactSelected(1,
                                            numeroCelulares(txtNumeros.getValue())), grupo, grupoId, 1); //TODO reemplazar 1 por usuario logeado
                        } else {
                             mensajes = mensajeService.prepararMensajes(txtMensaje.getValue(),
                                    contactoService.contactByGroup(grupoId), grupo, grupoId,1); //TODO reemplazar 1 por usuario logeado
                        }
