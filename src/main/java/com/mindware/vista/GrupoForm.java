...
public class GrupoForm extends CustomComponent {
	...
	private void deleteGrupo() {
		btnEliminar.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				try {
					ContactoGrupoService contactoGrupoService = new ContactoGrupoService();
					contactoGrupoService.deleteContactosGrupo(grupo);
					grupoService = new GrupoService();
					grupoService.deleteGrupo(grupo);
					MessageBox.createInfo()
							.withCaption("Eliminar grupo")
							.withMessage("Grupo " + nombreGrupo + " eliminado")
							.open();
					cabeceraTablas();
				} catch (Exception e) {
					MessageBox.createError()
							.withCaption("Eliminar grupo")
							.withMessage("Error al borrar el grupo " + e)
							.open();
				}
			}
		});
	...
	private void componerMensaje() {
		btnComponer.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				componerMensaje.listaGrupoUsuario(1);
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(horizontalLayout_1, "top:50.0px;right:0.0px;left:20.0px;");
		
		// horizontalLayout_2
		horizontalLayout_2 = buildHorizontalLayout_2();
		mainLayout.addComponent(horizontalLayout_2, "top:90.0px;left:20.0px;");
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		btnNuevo.setWidth("160px");
		btnNuevo.setHeight("37px");
